...
echo "RPC: $networkURL"
echo "${green}Set marketplaceProxy in KarmaProxy${reset}"

castSendHeader="cast send --rpc-url $networkURL$API_KEY $walletArgs"
castArgs="$karmaProxyAddress setMechMarketplaceStatuses(address[],bool[]) [$mechMarketplaceProxyAddress] [true]"
echo $castArgs
